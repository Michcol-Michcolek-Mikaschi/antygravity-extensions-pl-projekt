...
// =====================================================================
export const sidebarSettingsTranslations: TranslationEntry[] = [
    {
...
// =====================================================================
export const sidebarLabelsTranslations: TranslationEntry[] = [
...
// =====================================================================
export const windowTitleTranslations: TranslationEntry[] = [
...
// =====================================================================
export const sectionTitleTranslations: TranslationEntry[] = [
...
// =====================================================================
export const agentManagerTranslations: TranslationEntry[] = [
...
// =====================================================================
export const chatTranslations: TranslationEntry[] = [
...
//  H. PLACEHOLDERS
// =====================================================================
export const placeholderTranslations: TranslationEntry[] = [
...
//  I. ONBOARDING / WIZARD
// =====================================================================
export const onboardingTranslations: TranslationEntry[] = [
...
// =====================================================================
export const childrenShortTranslations: TranslationEntry[] = [
...
// =====================================================================
export const quotedStringsTranslations: TranslationEntry[] = [
...
export function getAllTranslations(): TranslationEntry[] {
    return [
        ...
        ...sidebarSettingsTranslations,
        // 2. Sidebar labels
        ...sidebarLabelsTranslations,
        // 3. Tytuł okna
        ...windowTitleTranslations,
        // 4. Sekcje (title:"...")
        ...sectionTitleTranslations,
        // 5. Settings — pełne label+description (dłuższe PRZED krótszymi)
        ...settingsTranslations,
        // 6. Agent Manager
        ...agentManagerTranslations,
        // 7. Chat
        ...chatTranslations,
        // 8. Placeholders
