...
exports.QuickRefPanel = void 0;
const vscode = __importStar(require("vscode"));
const BasePanel_1 = require("./BasePanel");
class QuickRefPanel extends BasePanel_1.BasePanel {
    static currentPanel;
    static viewType = 'antigravityPL.quickRef';
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(QuickRefPanel.viewType, '📋 Ściągawka Antigravity PL', column || vscode.ViewColumn.One, { enableScripts: true, retainContextWhenHidden: true });
...
exports.QuickRefPanel = QuickRefPanel;
//# sourceMappingURL=QuickRefPanel.js.map