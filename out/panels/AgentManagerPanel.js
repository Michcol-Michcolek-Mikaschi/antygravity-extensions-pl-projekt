...
exports.AgentManagerPanel = void 0;
const vscode = __importStar(require("vscode"));
const BasePanel_1 = require("./BasePanel");
class AgentManagerPanel extends BasePanel_1.BasePanel {
    static currentPanel;
    static viewType = 'antigravityPL.agentManager';
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(AgentManagerPanel.viewType, '🤖 Menedżer Agentów — Przewodnik PL', column || vscode.ViewColumn.One, { enableScripts: true, retainContextWhenHidden: true });
...
exports.AgentManagerPanel = AgentManagerPanel;
//# sourceMappingURL=AgentManagerPanel.js.map