...
exports.RoadmapPanel = void 0;
const vscode = __importStar(require("vscode"));
const BasePanel_1 = require("./BasePanel");
class RoadmapPanel extends BasePanel_1.BasePanel {
    static currentPanel;
    static viewType = 'antigravityPL.roadmap';
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(RoadmapPanel.viewType, '🗺️ Roadmapa — Tworzenie rozszerzenia', column || vscode.ViewColumn.One, { enableScripts: true, retainContextWhenHidden: true });
...
exports.RoadmapPanel = RoadmapPanel;
//# sourceMappingURL=RoadmapPanel.js.map